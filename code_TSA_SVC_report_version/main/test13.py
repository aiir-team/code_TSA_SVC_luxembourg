...
import pandas as pd
from utils import PreProcessing2Classes, HandlingIO


# Preprocessing
handle_io = HandlingIO()
pathsave = "results/test13/"
...
for max_feature in max_features:
    preprocessing = PreProcessing2Classes(max_feature)
    ...
    for kernel in kernels:
        ...
        handle_io._save_all_results_to_csv__(final_result, "test13_final", pathsave)
