...
for max_feature in max_features:
    ...
    X_train, X_test, y_train, y_test = train_test_split(dataset, raw_dataset["sentiment"], test_size=0.5, random_state=0)
    for kernel in kernels:
        ...
        handle_io._save_all_results_to_csv__(final_result, "test2_final", pathsave)
